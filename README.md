...
❗ **Комментарий к проекту:** Это первые мои попытки написать и защитить некоторые алгоритмы и структуры данных. Делалось мной с самоотдачей и аккуратно, но, как бывает посреди семестра, с большой спешкой :), и преподы тоже не успевали всё посмотреть. Алгоритмый и структуры данных тут очень разные, смотреть ниже.
