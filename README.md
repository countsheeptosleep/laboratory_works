# Алгоритмы и структуры данных C++ (2022) (лабораторные работы) / Laboratory works C++ 

❗ **Важный комментарий к проекту:** 
- делалось мной с самоотдачей, но, как бывает посреди семестра, _**с очень большой спешкой :)**_, и преподы тоже не всё успели внимательно посмотреть и подсказать, к сожалению;
- первая защита алгоритмов в ВУЗе.
