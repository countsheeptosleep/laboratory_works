# 2022 Алгоритмы и структуры данных на C++ (RU)

> ❤️ Дисклеймер  
❗ **Местами возможен спагетти-код, проект с очень давних времен**  
Проект перенасыщен комментариями и отступами - первые лабы в жизни :)
